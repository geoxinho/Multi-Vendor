...
export async function POST(req: NextRequest, { params }: Params) {
  try {
    ...
    if (action === "approve") {
          ...
          html: `
            <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;border:1px solid #e5e7eb;">
              ...
              <div style="padding:32px;">
                ...
                <p style="color:#4b5563;font-size:14px;line-height:1.6;margin:0 0 24px;">Your product <strong>"${updatedProduct.title}"</strong> has been approved and is now live on CampusGo!</p>
      ...
      return NextResponse.json({ message: "Product approved.", product: updatedProduct });
    }
      ...
      sendMail({
        ...
        html: `
          <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;border:1px solid #e5e7eb;">
            ...
            <div style="padding:32px;">
              <p style="color:#111827;font-size:15px;margin:0 0 16px;">Hi <strong>${seller.storeName || seller.name}</strong>,</p>
              <p style="color:#4b5563;font-size:14px;line-height:1.6;margin:0 0 24px;">Your product <strong>"${updatedProduct.title}"</strong> could not be approved. Please review the reason below and update your listing.</p>
    ...
    return NextResponse.json({ message: "Product rejected. Seller notified.", product: updatedProduct });
  } catch (err) {
